...
\vspace{0.5em}
\textbf{Artifacts.} Dashboard: \url{https://societiesdemo-egqj7tmwe-sonnyfully12-icloudcoms-projects.vercel.app}. Saved run id: \texttt{full-stage8}. Raw run file: \texttt{backend/runs/full-stage8.json}.
